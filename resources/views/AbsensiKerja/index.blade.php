...
<section class="content">
                    ...
                    <div class="col-md-12 col-sm-3 bg-white">
                        <div class="x_title">
                            ...
                            <div class="float-right ml-auto">
                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalFormAbsensiKerja">
                                    Tambah AbsensiKerja
                                </button>
                                <a href="{{ route('export-AbsensiKerja') }}" class= "btn btn-success"> 
                                <i class="fa fa-file-excel"></i> Export
                                </a>
                                <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#formImport">
                                <i class="fas fa-file-excel"></i> Import
                            </button>
                            <a href="{{ route('export-AbsensiKerja-pdf') }}" class= "btn btn-danger"> 
                        ...
                        <div class="card-body">
                            ...
                            @endif
                            <div class="mt-3">
                                @include('AbsensiKerja.table')
                                @include('AbsensiKerja.import')
                            </div>
    ...
    @include('AbsensiKerja.modal')
</section>
@endsection

@push('script')
<script>
    // $('#tbl-AbsensiKerja').DataTable()
    ...
    $('#modalFormAbsensiKerja').on('show.bs.modal', function(e) {
        ...
        if (mode === 'edit') {
            ...
            modal.find('.modal-title').text('Edit Data AbsensiKerja')
            ...
            modal.find('.modal-body form').attr('action', '{{ url("AbsensiKerja")}}/' + id)
            modal.find('#method').html('@method("PATCH")')
        } else {
            modal.find('.modal-title').text('Input Data AbsensiKerja')
            ...
            modal.find('.modal-body form').attr('action', '{{ url("AbsensiKerja") }}')
        }
    })
</script>
@endpush